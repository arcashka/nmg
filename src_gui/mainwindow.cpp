...
void MainWindow::connectSignalSlots() {
    ...
    // spec autoupdate
    connect(ui->graphicsView, SIGNAL(resize(QResizeEvent*)), this, SLOT(fitInView()));
    connect(ui->graphicsView, SIGNAL(resizeEvent()), this, SLOT(fitInView()));
    connect(ui->pushButtonLight, SIGNAL(clicked(bool)), this, SLOT(focusToOpenGl()));
