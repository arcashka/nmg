...
public:
    ...
    void setRotationXY(float angle1, float angle2);
...
//Q_DECLARE_TYPEINFO(Transform3D, Q_VABLE_TYPE);
...
inline void Transform3D::setRotationXY(float angle1, float angle2) {
    setRotation(QQuaternion::fromAxisAndAngle(QVector3D(1.0f, 0.0f, 0.0f), angle1) *
                QQuaternion::fromAxisAndAngle(QVector3D(0.0f, 1.0f, 0.0f), angle2));
}
